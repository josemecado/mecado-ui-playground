...
const primitives = {
  colors: {
    ...
    // Blues
    blue400: '#2f3e4c',      // Primary action color
...
const aliasTokens = {
  light: {
    // Backgrounds (--bg-*)
    backgroundPrimary: primitives.colors.gray900,      // --theme-lightBgPrimary: #edf0f2
    ...
    primaryBrand: primitives.colors.blue400,           // --theme-lightPrimaryAction: #2f3e4c
    primaryAlternate: primitives.colors.gray000,         // --theme-lightPrimaryAlternate: #2f3e4c
    ...
    // Accents (--accent-*)
    accentPrimary: primitives.colors.gray500,          // --theme-lightAccentPrimary: #738491
    accentSecondary: primitives.colors.blue400,        // --theme-lightAccentSecondary: #2f3e4c
    accentNeutral: primitives.colors.gray900,          // --theme-lightAccentNeutral: #edf0f2
  ...
  dark: {
    // Backgrounds (--bg-*)
    backgroundPrimary: primitives.colors.gray000,      // --theme-darkBgPrimary: #000000
    ...
    // Brand/Primary Actions (--primary-*)
    primaryBrand: primitives.colors.blue400,           // --theme-darkPrimaryAction: #2f3e4c
    primaryAlternate: primitives.colors.gray1000,        // --theme-darkPrimaryAlternate: #ffffff
    ...
    // Accents (--accent-*)
    accentPrimary: primitives.colors.gray500,          // --theme-darkAccentPrimary: #738491
    accentSecondary: primitives.colors.gray500,        // --theme-darkAccentSecondary: #738491
    accentNeutral: primitives.colors.gray500,          // --theme-darkAccentNeutral: #738491
