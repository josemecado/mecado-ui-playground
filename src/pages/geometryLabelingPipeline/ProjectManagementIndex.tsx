...
// Types (consolidated)
import { UnifiedTask, TaskContext, GeometryData } from "./types";
...
import { UserDashboardView } from "./user/views/UserDashboardView";

// Tools
import { SimpleFileUploader } from "./tools/uploader/SimpleFileUploader";
import { GeoLabelManagerWrapper } from "./tools/labeler/GeoLabelManagerWrapper";

// Navigation
import { SideMenu } from "./shared/navigation/SideMenu";
import { ViewType } from "./shared/navigation/NavigationTypes";
